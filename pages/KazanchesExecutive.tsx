    ...
    >
      <div className={`w-full md:w-1/2 h-[50vh] md:h-[60vh] flex ${isLeft ? 'justify-end' : 'justify-start'}`}>
        ...
        >
          ...
          >
            <img 
              src={`https://images.unsplash.com/photo-1497366754035-f200968a6e72?auto=format&fit=crop&q=80&w=1200&sig=${index + 205}`} 
      ...
      <div className={`w-full md:w-1/2 space-y-6 reveal px-4 md:px-12`}>
        ...
        <div className="space-y-4 max-w-lg">
          <p className="text-gray-800 font-light leading-relaxed text-lg">
            At {projectName}, {feature.toLowerCase()} is more than an amenity: it is a cornerstone of the professional experience, designed to foster global connectivity.
          </p>
    ...
    <div className="bg-refenti-offwhite min-h-screen">
      ...
      <section className="relative h-screen w-full flex items-end justify-center bg-refenti-offwhite overflow-hidden pb-32">
        ...
        <div className="relative z-10 text-center space-y-12 px-4 max-w-6xl mx-auto reveal active">
          <div className="space-y-6">
            ...
            <h1 className="font-display text-7xl md:text-[10rem] font-light text-refenti-charcoal tracking-tighter leading-none uppercase">Kazanches Executive</h1>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div className="space-y-12 reveal">
            <div className="space-y-8">
              <h2 className="font-display text-4xl md:text-6xl font-light text-refenti-charcoal leading-tight uppercase">
                Empowering <br/><span className="text-refenti-gold italic">Global Leadership</span>
              </h2>
              <p className="text-xl text-gray-800 font-light leading-relaxed max-w-xl">
                Kazanches Executive is the premier address for the international business community. This development provides a node for global enterprise, combining structural rigidity with the flexibility required by modern industries.
              </p>
            </div>
          </div>
          ...
          <div className="relative aspect-[4/5] md:aspect-[16/10] overflow-hidden rounded-[4rem] shadow-2xl reveal">
             <img 
               ...
               className="w-full h-full object-cover" 
               alt="Kazanches Executive Architecture" 
             />
      ...
      <section className="bg-refenti-offwhite pb-32">
        <div className="w-full">
          {projectFeatures.map((feature, idx) => (
            <FeatureSection key={feature} feature={feature} index={idx} projectName="Kazanches Executive" />
          ))}
        </div>
      </section>
      ...
      <footer className="py-24 px-8 bg-white text-center reveal border-t border-gray-100">
        <div className="max-w-3xl mx-auto space-y-8">
          <h2 className="font-display text-4xl font-light text-refenti-charcoal uppercase leading-none">
            Scale Your <span className="text-refenti-gold italic">Enterprise</span>
          </h2>
          <p className="text-gray-700 text-base font-light tracking-wide leading-relaxed">
            Limited leasing units remaining. Discover a level of professional exclusivity reserved for the global business elite.
          </p>
        </div>
      </footer>
    </div>
