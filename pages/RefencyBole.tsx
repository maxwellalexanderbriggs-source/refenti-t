...
const RefencyBole: React.FC = () => {
  ...
  return (
    <div className="bg-white">
      {/* Hero */}
      <section className="relative h-[85vh] w-full bg-white overflow-hidden reveal">
        ...
        <div className="absolute bottom-24 left-8 md:left-24 max-w-4xl space-y-6">
          ...
          <h1 className="font-display text-7xl md:text-9xl font-light text-refenti-charcoal tracking-tight leading-none uppercase">Refency Bolle</h1>
        </div>
      </section>

      {/* Narrative */}
      <section className="py-32 px-8 bg-white reveal">
              ...
              <div className="w-full md:w-2/5 space-y-6">
                ...
                <div className="space-y-4">
                  <p className="text-gray-500 font-light leading-relaxed text-lg">
                    The {feature.toLowerCase()} at Refency Bolle is designed for the discerning global citizen. Every detail has been meticulously scrutinized to ensure a seamless fusion of high-fashion utility and aesthetic purity. 
                  </p>
                  <p className="text-gray-500 font-light leading-relaxed text-lg">
      ...
      <section className="py-40 px-8 bg-white text-center reveal">
        <div className="max-w-4xl mx-auto space-y-16">
          <div className="space-y-4">
            <h2 className="font-display text-6xl md:text-8xl font-light tracking-tight text-refenti-charcoal uppercase">Elevate Your <br/><span className="text-refenti-gold italic text-shadow-hero">Standard</span></h2>
