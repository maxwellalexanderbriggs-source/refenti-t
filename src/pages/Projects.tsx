                ...
                <div className="space-y-6 px-6 md:px-10">
                  <div className="space-y-3">
                    <div className="flex items-center gap-4">
                      <p className="text-[10px] font-bold tracking-[0.4em] text-refenti-gold uppercase">
                        {project.assetClass}
                      </p>
                  ...
                  <div className="pt-4">
                    <span className="inline-flex translate-x-[-10px] items-center gap-4 text-[9px] font-bold tracking-ultra text-refenti-gold uppercase opacity-0 transition-all duration-700 group-hover:translate-x-0 group-hover:opacity-100">
